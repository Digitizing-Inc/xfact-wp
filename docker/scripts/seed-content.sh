...
<!-- wp:xfact/case-study-grid {"sectionLabel":"Case Studies","heading":"Proof in Municipal, State","description":"Engagements where xFact has helped public-sector teams strengthen the systems behind their work.","items":[{"title":"Public Safety Data Broker Solution","summary":"A high-volume, fault-tolerant message broker enabling standardized criminal-justice information sharing across state, federal, and international systems.","source":"xFact","linkUrl":"/case-studies/public-safety-data-broker/"},{"title":"License Management System","summary":"A modular firearms-licensing platform rolled out across 350+ local police departments and all state-licensed firearms dealers — the first solution of its kind in the USA.","source":"xFact","linkUrl":"/case-studies/license-management-system/"},{"title":"Cloud Migration Strategic Roadmap","summary":"A comprehensive cloud migration roadmap and serverless architecture recommendations for a major criminal-justice agency, meeting FedRAMP High and CJIS compliance.","source":"xFact","linkUrl":"/case-studies/cloud-migration-strategic-roadmap/"}]} /-->
...
for cs_slug in public-safety-data-broker license-management-system cloud-migration-strategic-roadmap; do

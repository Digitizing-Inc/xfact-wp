...
<!-- wp:xfact/navigation-cards {"heading":"Other Industries","items":[{"title":"Municipal, State \u0026 Local Government","icon":"Landmark","href":"/solutions/government"},{"title":"Education","icon":"GraduationCap","href":"/solutions/education"},{"title":"Health \u0026 Human Services","icon":"HeartPulse","href":"/solutions/health-and-human-services"},{"title":"Infrastructure \u0026 Managed Services","icon":"ServerCog","href":"/solutions/infrastructure"}]} /-->'

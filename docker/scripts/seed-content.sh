...
<!-- wp:xfact/case-study-grid {"sectionLabel":"Case Studies","heading":"Proof in Public Safety","description":"Engagements where xFact has helped public-sector teams strengthen the systems behind their work.","items":[{"title":"Public Safety Data Broker Solution","summary":"Coordinated data brokerage platform connecting law-enforcement systems while preserving security and compliance.","source":"xFact","linkUrl":"/case-studies/public-safety-data-broker/"},{"title":"License Management System","summary":"Modernized licensing workflows for a state public-safety agency, replacing legacy paper-based processes with secure digital ones.","source":"xFact","linkUrl":"/case-studies/license-management-system/"},{"title":"Cloud Migration Strategic Roadmap","summary":"A phased cloud-migration plan that preserved real-time availability for mission-critical public-safety operations.","source":"xFact","linkUrl":"/case-studies/cloud-migration-strategic-roadmap/"}]} /-->
...
<!-- wp:xfact/case-study-grid {"sectionLabel":"Case Studies","heading":"Proof in Municipal, State","description":"Engagements where xFact has helped public-sector teams strengthen the systems behind their work.","items":[{"title":"Enterprise Risk Management Plan","summary":"Built a scalable ERM program for a growing state-wide IT agency, enabling consistent risk oversight, regulatory compliance, and informed decision-making across newly integrated units.","source":"xFact","linkUrl":"/case-studies/enterprise-risk-management-plan/"},{"title":"Hybrid Cloud Data Center Migration","summary":"Enabled a cost-effective transition to a hybrid and multi-cloud environment for a state-wide IT agency, modernizing application infrastructure while maintaining operational continuity, improving security, and supporting future scalability.","source":"xFact","linkUrl":"/case-studies/hybrid-cloud-data-center-migration/"},{"title":"Covid19 and Collaboration","summary":"Enabled DataServ to rapidly transition to a remote workforce during the COVID-19 crisis by leveraging an established collaboration framework, ensuring business continuity, secure operations, and uninterrupted client support.","source":"Dataserv","linkUrl":"/case-studies/covid-19-collaboration-remote-work-enablement/"}]} /-->
...
<!-- wp:xfact/case-study-grid {"sectionLabel":"Case Studies","heading":"Proof in Health","description":"Engagements where xFact has helped public-sector teams strengthen the systems behind their work.","items":[{"title":"HHS Child Welfare Case Management System Modernization","summary":"Modernization of a state child-welfare case-management platform, replacing siloed legacy tooling with an integrated system.","source":"xFact","linkUrl":"/case-studies/hhs-child-welfare-case-management-system-modernization/"},{"title":"Healthcare Operations Optimization","summary":"Operational and infrastructure improvements for a regional healthcare provider, focused on reliability and continuous availability.","source":"DataServ","linkUrl":"/case-studies/healthcare/"}]} /-->

...
<!-- wp:xfact/case-study-grid {"sectionLabel":"Related Work","items":[{"title":"Public Safety Data Broker Solution","summary":"Coordinated data brokerage platform connecting law-enforcement systems while preserving security and compliance.","source":"xFact"},{"title":"License Management System","summary":"Modernized licensing workflows for a state public-safety agency, replacing legacy paper-based processes with secure digital ones.","source":"xFact"},{"title":"Cloud Migration Strategic Roadmap","summary":"A phased cloud-migration plan that preserved real-time availability for mission-critical public-safety operations.","source":"xFact"}]} /-->
...
<!-- wp:xfact/case-study-grid {"sectionLabel":"Related Work","items":[{"title":"Public Safety Data Broker Solution","summary":"A high-volume, fault-tolerant message broker enabling standardized criminal-justice information sharing across state, federal, and international systems.","source":"xFact"},{"title":"License Management System","summary":"A modular firearms-licensing platform rolled out across 350+ local police departments and all state-licensed firearms dealers — the first solution of its kind in the USA.","source":"xFact"},{"title":"Cloud Migration Strategic Roadmap","summary":"A comprehensive cloud migration roadmap and serverless architecture recommendations for a major criminal-justice agency, meeting FedRAMP High and CJIS compliance.","source":"xFact"}]} /-->
...
<!-- wp:xfact/case-study-grid {"sectionLabel":"Related Work","items":[{"title":"HHS Child Welfare Case Management System Modernization","summary":"Modernization of a state child-welfare case-management platform, replacing siloed legacy tooling with an integrated system.","source":"xFact"},{"title":"Healthcare Operations Optimization","summary":"Operational and infrastructure improvements for a regional healthcare provider, focused on reliability and continuous availability.","source":"DataServ"}]} /-->

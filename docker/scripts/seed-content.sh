...
if [ -n "$HOME_ID" ]; then
    wp post update "$HOME_ID" --post_content='<!-- wp:xfact/hero {"heroVariant":"media","title":"*Your partner* behind the systems communities rely on","subtitle":"xFact partners with public institutions to design, integrate, secure, and sustain mission-critical technology systems.","align":"full","slides":[{"src":"'"${ASSETS}"'/hero-solutions.jpg","alt":"Healthcare workers collaborating","position":"65% 30%"},{"src":"'"${ASSETS}"'/hero-contact.jpg","alt":"Students using technology","position":"center 35%"},{"src":"'"${ASSETS}"'/hero-careers.jpg","alt":"Volunteers working together","position":"center 30%"},{"src":"'"${ASSETS}"'/hero-support.jpg","alt":"Public safety operations","position":"70% 30%"}],"posterImage":"'"${ASSETS}"'/xfact-hero-poster.png","videoUrl":"'"${ASSETS}"'/xfact-hero.mp4","buttons":[{"label":"Let'\''s Talk","url":"/contact","variant":"primary"}]} /-->
...
<!-- wp:xfact/solutions-grid {"sectors":[{"title":"Public safety \u0026 justice","headline":"Law enforcement, courts, corrections, 911 systems","description":"Mission-critical systems that require continuous availability and uncompromising security.","iconName":"Shield","href":"/solutions/public-safety","bgColor":"var(--xfact-gradient-secondary-1)"},{"title":"Government \u0026 municipal","headline":"State, county, and local agencies","description":"Integrated systems that support public works, digital services, and civic infrastructure.","iconName":"Landmark","href":"/solutions/government","bgColor":"var(--xfact-gradient-secondary-3)"},{"title":"Education","headline":"K-12 districts and higher education","description":"Secure infrastructure that protects student data and supports continuous learning.","iconName":"GraduationCap","href":"/solutions/education","bgColor":"var(--xfact-gradient-secondary-2)"},{"title":"Health \u0026 human services","headline":"Healthcare, behavioral health, social services","description":"Compliant environments that balance accessibility with strict privacy requirements.","iconName":"HeartPulse","href":"/solutions/health-and-human-services","bgColor":"var(--xfact-gradient-secondary-4)"},{"title":"Infrastructure \u0026 managed services","headline":"DataServ, an xFact solution","description":"Hosted platforms and managed network operations that ensure operational stability.","iconName":"ServerCog","badge":"DataServ","href":"/solutions/infrastructure","bgColor":"var(--xfact-gradient-primary-2)"}],"buttons":[{"label":"Explore our solutions →","url":"/solutions","variant":"secondary"}]} /-->
...
<!-- wp:xfact/cta-section {"subtitle":"Whether you'\''re planning an upgrade, responding to a requirement, or evaluating a long-term partner — we'\''re the right conversation to start.","buttons":[{"label":"Contact xFact","url":"/contact","variant":"primary"}]} /-->'
    echo "  ✅ Seeded: Home"
fi
...
if [ -n "$ABT_ID" ]; then
    wp post update "$ABT_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"About xFact","title":"Behind the Systems Communities Rely On","subtitle":"Since 2000, the teams behind xFact have partnered with public-sector institutions to design, integrate, secure, and sustain mission-critical technology systems."} /-->

<!-- wp:xfact/text-section {"sectionLabel":"Our Story","heading":"Our Story","body":"xFact began as a public-sector technology services firm focused on helping state, local, and education organizations modernize the systems their communities depend on. Over time, that work expanded across infrastructure, cybersecurity, applications, and strategy — building on and unifying capabilities from DataServ, which now operates as an xFact solution within the broader organization. Today, xFact serves as a single accountable partner for the institutions behind public safety, government, education, and human services."} /-->
...
<!-- wp:xfact/cta-section {"subtitle":"Whether you'\''re planning an upgrade, evaluating a long-term partner, or starting an assessment — we'\''re the right conversation to start.","buttons":[{"label":"Contact xFact","url":"/contact","variant":"primary"}]} /-->'
    echo "  ✅ Seeded: About"
fi
...
if [ -n "$CAP_ID" ]; then
    wp post update "$CAP_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"Capabilities","title":"Integrated Capabilities for Mission-Critical Systems","subtitle":"Coordinated expertise supporting systems across their full lifecycle — from idea to action, design through long-term operation.","align":"full"} /-->
...
<!-- wp:xfact/cta-section {"align":"full","title":"Bring it all together.","subtitle":"Talk to us about coordinating your environments under one accountable partner.","buttons":[{"label":"Start a conversation","url":"/contact","variant":"primary"}]} /-->'
...
if [ -n "$NEWS_ID" ]; then
    wp post update "$NEWS_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"News \u0026 Insights","title":"News \u0026 Insights","subtitle":"Perspectives on public-sector systems and the technology behind them.","align":"full"} /-->
...
<!-- wp:xfact/cta-section {"align":"full","title":"Want to talk shop?","subtitle":"We share insights privately, too. Reach out and we can dive in on your environment.","buttons":[{"label":"Contact us","url":"/contact","variant":"primary"}]} /-->'
    echo "  ✅ Seeded: News"
fi
...
SOL_ID=$(wp post list --post_type=page --name=solutions --field=ID 2>/dev/null)
if [ -n "$SOL_ID" ]; then
    wp post update "$SOL_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"Solutions","title":"Reliable Systems. Stronger Communities.","subtitle":"xFact supports mission-critical systems across complex public-sector environments. A single accountable partner improves reliability and reduces complexity.","backgroundImage":"'"${ASSETS}"'/hero-solutions.jpg","imageAlt":"Healthcare workers collaborating","align":"full"} /-->

<!-- wp:xfact/solutions-grid {"sectionLabel":"Industries we support","heading":"Purpose-Built for Public-Sector Environments","subtitle":"Each industry has its own systems, governance, and accountability demands. Tap into the area that matters to your work.","sectors":[{"title":"Public Safety \u0026 Justice","headline":"Strengthening Systems That Cannot Fail","description":"Public safety agencies operate in environments where technology reliability is critical to real-time operations. Communications infrastructure and secure information environments must remain continuously available while meeting stringent security and compliance requirements.","iconName":"Shield","href":"/solutions/public-safety","bgColor":"var(--xfact-gradient-secondary-1)"},{"title":"Municipal, State \u0026 Local Government","headline":"Coordinating Systems That Support Communities","description":"State, municipal, and county governments rely on interconnected systems that support essential community services. From public works and administrative operations to digital services and civic infrastructure, these systems must remain secure, resilient, and continuously operational.","iconName":"Landmark","href":"/solutions/government","bgColor":"var(--xfact-gradient-secondary-3)"},{"title":"Education","headline":"Supporting Learning Through Reliable Systems","description":"Educational institutions manage interconnected systems that range from student information and learning management to operational infrastructure.","iconName":"GraduationCap","href":"/solutions/education","bgColor":"var(--xfact-gradient-secondary-2)"},{"title":"Health \u0026 Human Services","headline":"Supporting Systems That Serve Communities","description":"Health and human services agencies manage systems that must simultaneously ensure accessibility for constituents and comply with stringent privacy requirements.","iconName":"HeartPulse","href":"/solutions/health-and-human-services","bgColor":"var(--xfact-gradient-secondary-4)"},{"title":"Infrastructure \u0026 Managed Services","headline":"Resilient Infrastructure for Mission-Critical Systems","description":"We provide secure infrastructure environments designed to support the continuous operation of mission-critical public systems, delivering the stability, performance, and security required in high-accountability environments.","iconName":"ServerCog","badge":"DataServ","href":"/solutions/infrastructure","bgColor":"var(--xfact-gradient-primary-2)"}],"buttons":[]} /-->

<!-- wp:xfact/cta-section {"align":"full","title":"Ready to strengthen your systems?","subtitle":"Schedule an assessment to understand your current environment and identify a path forward.","buttons":[{"label":"Contact Us","url":"/contact","variant":"primary"}]} /-->'
...
if [ -n "$SOL_ID" ]; then
    ...
    if [ -n "$SUB_ID" ]; then
        wp post update "$SUB_ID" --post_content='<!-- wp:xfact/hero {"title":"Strengthening Systems That Cannot Fail","subtitle":"Supporting real-time operations where reliability is critical.","bodyText":"Public safety agencies operate in environments where technology reliability is critical to real-time operations. Communications infrastructure and secure information environments must remain continuously available while meeting stringent security and compliance requirements.","useBreadcrumbs":true,"align":"full"} /-->
...
<!-- wp:xfact/case-study-grid {"sectionLabel":"Case Studies","heading":"Proof in Public Safety","description":"Engagements where xFact has helped public-sector teams strengthen the systems behind their work.","items":[{"title":"Public Safety Data Broker Solution","linkUrl":"/case-studies/public-safety-data-broker/"},{"title":"License Management System","linkUrl":"/case-studies/license-management-system/"},{"title":"Cloud Migration Strategic Roadmap","linkUrl":"/case-studies/cloud-migration-strategic-roadmap/"}]} /-->

<!-- wp:xfact/navigation-cards {"heading":"Relevant Capabilities","items":[{"title":"Cybersecurity","subtitle":"Proactive defense for sensitive environments.","icon":"ShieldCheck","href":"/capabilities#cybersecurity"},{"title":"Infrastructure \u0026 Platform Environments","subtitle":"Resilient environments for mission-critical systems.","icon":"ServerCog","href":"/capabilities#infrastructure"},{"title":"Applications \u0026 Integration","subtitle":"Connecting systems for unified operations.","icon":"AppWindow","href":"/capabilities#applications-integration"}],"buttons":[{"label":"See all capabilities →","url":"/capabilities","variant":"secondary"}]} /-->

<!-- wp:xfact/navigation-cards {"sectionLabel":"MORE INDUSTRIES","heading":"Other systems we support","items":[{"title":"Municipal, State & Local Government","icon":"Landmark","href":"/solutions/government","bgColor":"var(--xfact-gradient-secondary-3)"},{"title":"Education","icon":"GraduationCap","href":"/solutions/education","bgColor":"var(--xfact-gradient-secondary-2)"},{"title":"Health & Human Services","icon":"HeartPulse","href":"/solutions/health-and-human-services","bgColor":"var(--xfact-gradient-secondary-4)"},{"title":"Infrastructure & Managed Services","icon":"ServerCog","href":"/solutions/infrastructure","bgColor":"var(--xfact-gradient-primary-2)"}],"buttons":[]} /-->
...
<!-- wp:xfact/cta-section {"align":"full","title":"Ready to strengthen your systems?","subtitle":"Schedule an assessment to understand your current environment and identify a path forward.","buttons":[{"label":"Contact Us","url":"/contact","variant":"primary"}]} /-->'
    ...
    if [ -n "$SUB_ID" ]; then
        wp post update "$SUB_ID" --post_content='<!-- wp:xfact/hero {"title":"Coordinating Systems That Support Communities","subtitle":"Supporting reliable technology environments across government operations.","bodyText":"State, municipal, and county governments rely on interconnected systems that support essential community services. From public works and administrative operations to digital services and civic infrastructure, these systems must remain secure, resilient, and continuously operational.","useBreadcrumbs":true,"align":"full"} /-->
...
<!-- wp:xfact/case-study-grid {"sectionLabel":"Case Studies","heading":"Proof in Municipal, State","description":"Engagements where xFact has helped public-sector teams strengthen the systems behind their work.","items":[{"title":"Enterprise Risk Management Plan","linkUrl":"/case-studies/enterprise-risk-management-plan/"},{"title":"Hybrid Cloud Data Center Migration","linkUrl":"/case-studies/hybrid-cloud-data-center-migration/"},{"title":"Covid19 and Collaboration","linkUrl":"/case-studies/covid-19-collaboration-remote-work-enablement/"}]} /-->

<!-- wp:xfact/navigation-cards {"heading":"Relevant Capabilities","items":[{"title":"Infrastructure \u0026 Platform Environments","subtitle":"Resilient environments for mission-critical systems.","icon":"ServerCog","href":"/capabilities#infrastructure"},{"title":"Data \u0026 Analytics Platforms","subtitle":"Actionable insights from complex data.","icon":"Database","href":"/capabilities#data-platforms"},{"title":"Strategy \u0026 Advisory","subtitle":"Aligning technology with operational goals.","icon":"Compass","href":"/capabilities#strategy-advisory"}],"buttons":[{"label":"See all capabilities →","url":"/capabilities","variant":"secondary"}]} /-->

<!-- wp:xfact/navigation-cards {"sectionLabel":"MORE INDUSTRIES","heading":"Other systems we support","items":[{"title":"Public Safety & Justice","icon":"Shield","href":"/solutions/public-safety","bgColor":"var(--xfact-gradient-secondary-1)"},{"title":"Education","icon":"GraduationCap","href":"/solutions/education","bgColor":"var(--xfact-gradient-secondary-2)"},{"title":"Health & Human Services","icon":"HeartPulse","href":"/solutions/health-and-human-services","bgColor":"var(--xfact-gradient-secondary-4)"},{"title":"Infrastructure & Managed Services","icon":"ServerCog","href":"/solutions/infrastructure","bgColor":"var(--xfact-gradient-primary-2)"}],"buttons":[]} /-->
...
<!-- wp:xfact/navigation-cards {"sectionLabel":"MORE INDUSTRIES","heading":"Other systems we support","items":[{"title":"Public Safety & Justice","icon":"Shield","href":"/solutions/public-safety","bgColor":"var(--xfact-gradient-secondary-1)"},{"title":"Municipal, State & Local Government","icon":"Landmark","href":"/solutions/government","bgColor":"var(--xfact-gradient-secondary-3)"},{"title":"Health & Human Services","icon":"HeartPulse","href":"/solutions/health-and-human-services","bgColor":"var(--xfact-gradient-secondary-4)"},{"title":"Infrastructure & Managed Services","icon":"ServerCog","href":"/solutions/infrastructure","bgColor":"var(--xfact-gradient-primary-2)"}],"buttons":[]} /-->
...
<!-- wp:xfact/cta-section {"align":"full","title":"Ready to strengthen your systems?","subtitle":"Schedule an assessment to understand your current environment and identify a path forward.","buttons":[{"label":"Contact Us","url":"/contact","variant":"primary"}]} /-->'
    ...
    # HHS
    SUB_ID=$(wp post list --post_type=page --name=health-and-human-services --field=ID 2>/dev/null)
    if [ -n "$SUB_ID" ]; then
        wp post update "$SUB_ID" --post_content='<!-- wp:xfact/hero {"title":"Supporting Systems That Serve Communities","subtitle":"Strengthening systems that support critical programs and services.","bodyText":"Health and human services agencies manage systems that must simultaneously ensure accessibility for constituents and comply with stringent privacy requirements.","useBreadcrumbs":true,"align":"full"} /-->
...
<!-- wp:xfact/case-study-grid {"sectionLabel":"Case Studies","heading":"Proof in Health","description":"Engagements where xFact has helped public-sector teams strengthen the systems behind their work.","items":[{"title":"HHS Child Welfare Case Management System Modernization","linkUrl":"/case-studies/hhs-child-welfare-case-management-system-modernization/"},{"title":"Healthcare Operations Optimization","linkUrl":"/case-studies/healthcare/"}]} /-->

<!-- wp:xfact/navigation-cards {"heading":"Relevant Capabilities","items":[{"title":"Cybersecurity","subtitle":"Proactive defense for sensitive environments.","icon":"ShieldCheck","href":"/capabilities#cybersecurity"},{"title":"Data \u0026 Analytics Platforms","subtitle":"Actionable insights from complex data.","icon":"Database","href":"/capabilities#data-platforms"},{"title":"Applications \u0026 Integration","subtitle":"Connecting systems for unified operations.","icon":"AppWindow","href":"/capabilities#applications-integration"}],"buttons":[{"label":"See all capabilities →","url":"/capabilities","variant":"secondary"}]} /-->

<!-- wp:xfact/navigation-cards {"sectionLabel":"MORE INDUSTRIES","heading":"Other systems we support","items":[{"title":"Public Safety & Justice","icon":"Shield","href":"/solutions/public-safety","bgColor":"var(--xfact-gradient-secondary-1)"},{"title":"Municipal, State & Local Government","icon":"Landmark","href":"/solutions/government","bgColor":"var(--xfact-gradient-secondary-3)"},{"title":"Education","icon":"GraduationCap","href":"/solutions/education","bgColor":"var(--xfact-gradient-secondary-2)"},{"title":"Infrastructure & Managed Services","icon":"ServerCog","href":"/solutions/infrastructure","bgColor":"var(--xfact-gradient-primary-2)"}],"buttons":[]} /-->
...
<!-- wp:xfact/cta-section {"align":"full","title":"Ready to strengthen your systems?","subtitle":"Schedule an assessment to understand your current environment and identify a path forward.","buttons":[{"label":"Contact Us","url":"/contact","variant":"primary"}]} /-->'
    ...
    if [ -n "$SUB_ID" ]; then
        wp post update "$SUB_ID" --post_content='<!-- wp:xfact/hero {"title":"Resilient Infrastructure for Mission-Critical Systems","bodyText":"We provide secure infrastructure environments designed to support the continuous operation of mission-critical public systems, delivering the stability, performance, and security required in high-accountability environments.","badgeText":"DataServ, an xFact solution","useBreadcrumbs":true,"align":"full"} /-->
...
<!-- wp:xfact/navigation-cards {"heading":"Relevant Capabilities","items":[{"title":"Infrastructure \u0026 Platform Environments","subtitle":"Resilient environments for mission-critical systems.","icon":"ServerCog","href":"/capabilities#infrastructure"},{"title":"Cybersecurity","subtitle":"Proactive defense for sensitive environments.","icon":"ShieldCheck","href":"/capabilities#cybersecurity"}],"buttons":[{"label":"See all capabilities →","url":"/capabilities","variant":"secondary"}]} /-->

<!-- wp:xfact/navigation-cards {"sectionLabel":"MORE INDUSTRIES","heading":"Other systems we support","items":[{"title":"Public Safety & Justice","icon":"Shield","href":"/solutions/public-safety","bgColor":"var(--xfact-gradient-secondary-1)"},{"title":"Municipal, State & Local Government","icon":"Landmark","href":"/solutions/government","bgColor":"var(--xfact-gradient-secondary-3)"},{"title":"Education","icon":"GraduationCap","href":"/solutions/education","bgColor":"var(--xfact-gradient-secondary-2)"},{"title":"Health & Human Services","icon":"HeartPulse","href":"/solutions/health-and-human-services","bgColor":"var(--xfact-gradient-secondary-4)"}],"buttons":[]} /-->
...
if [ -n "$SUP_ID" ]; then
    wp post update "$SUP_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"Support","title":"Access assistance for your systems and services.","subtitle":"Ongoing support maintains system reliability. Our structured processes enable efficient response and timely issue resolution.","backgroundImage":"'"${ASSETS}"'/hero-support.jpg","imageAlt":"Police officer on duty","align":"full"} /-->

<!-- wp:xfact/support-channels /-->

<!-- wp:xfact/cta-section {"variant":"default","title":"Existing Client?","subtitle":"Access your support portal to submit tickets, track issues, and review service history.","buttons":[{"label":"Open Support Portal","url":"https://portal.dataservtech.com/","variant":"primary"}]} /-->'
    echo "  ✅ Seeded: Support"
fi
...
if [ -n "$CAR_ID" ]; then
    wp post update "$CAR_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"Careers","title":"Work behind the systems communities rely on.","subtitle":"Join a team that supports mission-critical technology for public-sector organizations. Build systems that must work every day.","backgroundImage":"'"${ASSETS}"'/hero-careers.jpg","imageAlt":"Volunteers working together","align":"full"} /-->
...
<!-- wp:xfact/cta-section {"variant":"light","align":"full","title":"Interested in joining the team?","subtitle":"We'\''re always looking for talented people who want to do meaningful work.","buttons":[{"label":"Get in Touch","url":"/contact","variant":"primary"}]} /-->'
    echo "  ✅ Seeded: Careers"
fi
...
if [ -n "$CON_ID" ]; then
    wp post update "$CON_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"Contact","title":"Start the Conversation","subtitle":"Complex environments require thoughtful evaluation.","backgroundImage":"'"${ASSETS}"'/hero-contact.jpg","imageAlt":"Kids using technology in the classroom","align":"full"} /-->

<!-- wp:xfact/contact-form {"heading":"Get in Touch","subtitle":"Tell us about your organization and what you'\''re looking to accomplish. We'\''ll connect you with the right team.","buttons":[{"label":"Request an Assessment","url":"#assessment","variant":"secondary"}]} /-->'
    echo "  ✅ Seeded: Contact"
fi
...
if [ -n "$LDR_ID" ]; then
    wp post update "$LDR_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"Leadership","title":"Our Leadership","subtitle":"Guiding our mission to support public sector organizations through technology.","align":"full"} /-->
...
if [ -n "$PRI_ID" ]; then
    wp post update "$PRI_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"Legal","title":"Privacy Policy","subtitle":"Effective date: January 1, 2025","backgroundImage":"'"${ASSETS}"'/hero-contact.jpg","imageAlt":"Privacy and security","align":"full"} /-->
...
if [ -n "$TER_ID" ]; then
    wp post update "$TER_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"Legal","title":"Terms of Service","subtitle":"Effective date: January 1, 2025","backgroundImage":"'"${ASSETS}"'/hero-contact.jpg","imageAlt":"Terms and conditions","align":"full"} /-->
...
# Clean up old case study pages
echo "🧹 Cleaning up old case study pages..."
for cs_slug in public-safety-data-broker license-management-system cloud-migration-strategic-roadmap enterprise-risk-management-plan hybrid-cloud-data-center-migration hhs-child-welfare-case-management-system-modernization covid-19-collaboration-remote-work-enablement healthcare; do
    OLD_ID=$(wp post list --post_type=page --name="$cs_slug" --field=ID 2>/dev/null)
    if [ -n "$OLD_ID" ]; then
        wp post delete "$OLD_ID" --force
    fi
done
...
for cs_info in \
    ...
    "Cloud Migration Strategic Roadmap:cloud-migration-strategic-roadmap" \
    "Enterprise Risk Management Plan:enterprise-risk-management-plan" \
    "Hybrid Cloud Data Center Migration:hybrid-cloud-data-center-migration" \
    "COVID-19 Collaboration & Remote Work Enablement:covid-19-collaboration-remote-work-enablement" \
    "HHS Child Welfare Case Management System Modernization:hhs-child-welfare-case-management-system-modernization" \
    "Healthcare:healthcare";
    do
    cs_title="${cs_info%%:*}"
    cs_slug="${cs_info##*:}"
    if ! wp post list --post_type=case_study --name="$cs_slug" --field=ID 2>/dev/null | grep -q .; then
        wp post create --post_type=case_study --post_title="$cs_title" --post_name="$cs_slug" --post_status=publish
        echo "  ✅ Created case study: $cs_title ($cs_slug)"
    fi
done

CS1_ID=$(wp post list --post_type=case_study --name=public-safety-data-broker --field=ID 2>/dev/null)
if [ -n "$CS1_ID" ]; then
    wp post update "$CS1_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel": "Case Studies", "title": "Public Safety Data Broker Solution", "subtitle": "A high-volume, fault-tolerant message broker enabling standardized criminal-justice information sharing across state, federal, and international systems.", "align": "full"} /-->

<!-- wp:xfact/case-study-details {"summary":"Coordinated data brokerage platform connecting law-enforcement systems while preserving security and compliance.","source":"xFact","client": "State-wide Criminal Justice Information Services Agency", "challenge": ["Facilitate a standardized way of sharing disparate criminal justice information across systems.", "Interface with multiple state, federal, and international data sources while avoiding API explosion and ensuring data-driven transactions could be handled efficiently.", "Provide high-volume message handling, guaranteed secure message delivery, and mission-critical system performance and reliability."], "services": ["Collaboratively planned and designed/architected a component-based solution that emphasized scalability, fault tolerance, and security.", "Rapidly implemented a high-volume, high-performance message broker with intelligent header-based message formatting and guaranteed delivery.", "Incorporated comprehensive advanced security protocols to ensure message integrity and confidentiality, including end-to-end encryption and secure access controls.", "Leveraged state-of-the-art technologies to ensure the system could scale to handle transaction bursts while maintaining a minimal memory footprint."], "outcomes": ["Provided standards-based integration of multiple state, federal, and international data sources.", "Successfully processing over 2.5 million transactions daily, with the capability to handle bursts of up to 5 million transactions, ensuring timely access to critical criminal justice information.", "Guaranteed secure message delivery with a highly fault-tolerant architecture, significantly reducing the risk of data breaches and system downtime.", "Streamlined operations, reducing complexity and enhancing efficiency for law enforcement agencies."], "narrative": "xFact\u2019s Public Safety Data Broker Solution exemplifies cutting-edge technology application in public safety, demonstrating our firm\u2019s commitment to developing solutions that meet the critical needs of law enforcement agencies. Through strategic planning, technical excellence, and a focus on security and scalability, we have delivered a system that not only meets but exceeds the expectations of our client, paving the way for safer communities through improved information sharing."} /-->

<!-- wp:xfact/cta-section {"align":"full","title":"Ready to strengthen your systems?","subtitle":"Schedule an assessment to understand your current environment and identify a path forward.","buttons":[{"label":"Contact Us","url":"/contact","variant":"primary"}]} /-->'
fi

CS2_ID=$(wp post list --post_type=case_study --name=license-management-system --field=ID 2>/dev/null)
if [ -n "$CS2_ID" ]; then
    wp post update "$CS2_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel": "Case Studies", "title": "License Management System", "subtitle": "A modular firearms-licensing platform rolled out across 350+ local police departments and all state-licensed firearms dealers \u2014 the first solution of its kind in the USA.", "align": "full"} /-->

<!-- wp:xfact/case-study-details {"summary":"Modernized licensing workflows for a state public-safety agency, replacing legacy paper-based processes with secure digital ones.","source":"xFact","client": "State-wide Firearms Licensing Agency", "challenge": ["Plan, test, and implement a mission-critical roll-out to comply with legal requirements for firearms licensing.", "Satisfy diverse end-user training requirements and change management needs to ensure successful transition from paper/manual processes to a fully electronic model.", "Maintain and synchronize legacy system in parallel with phased roll-out of new platform."], "services": ["Modularized License Management System platform.", "Re-usable testing processes, protocols, and tools to ensure compliance with all business and legal requirements.", "Data migration and synchronization with legacy system.", "Comprehensive training programs and materials for various types of end-users, operational managers, and support personnel.", "\u201cRoadshow\u201d style training and deployments to engage stakeholders and ensure implementation success."], "outcomes": ["Successfully implemented all deployments and go-live phases across over 350 local police departments and all state-licensed firearms dealers.", "Mitigated risks and expectations for service levels to ensure a smooth deployment and trust in the new system.", "Recognized as an innovative government solution and the first solution of its kind deployed in the USA.", "Successfully facilitated funding for additional enhancements and phases."]} /-->

<!-- wp:xfact/cta-section {"align":"full","title":"Ready to strengthen your systems?","subtitle":"Schedule an assessment to understand your current environment and identify a path forward.","buttons":[{"label":"Contact Us","url":"/contact","variant":"primary"}]} /-->'
fi

CS3_ID=$(wp post list --post_type=case_study --name=cloud-migration-strategic-roadmap --field=ID 2>/dev/null)
if [ -n "$CS3_ID" ]; then
    wp post update "$CS3_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel": "Case Studies", "title": "Cloud Migration Strategic Roadmap", "subtitle": "A comprehensive cloud migration roadmap and serverless architecture recommendations for a major criminal-justice agency, meeting FedRAMP High and CJIS compliance.", "align": "full"} /-->

<!-- wp:xfact/case-study-details {"summary":"A phased cloud-migration plan that preserved real-time availability for mission-critical public-safety operations.","source":"xFact","client": "Major Public Sector Criminal Justice Agency", "challenge": ["Delivering a comprehensive cloud migration approach and recommendations to support hybrid connectivity and a move towards a serverless architecture, balancing the need to maintain legacy systems with the advantages of cloud-based solutions.", "Identifying recommendations around robust security measures, including multi-factor authentication and a comprehensive backup and recovery strategy, to protect sensitive criminal justice information.", "Accurately evaluating the current infrastructure, including virtual machines, physical servers, and critical software components like ETL and SSIS packages, to understand the baseline and identify areas for improvement.", "Ensuring government cloud compliance via a new system architecture complied with stringent government cloud standards, including FedRAMP High and CJIS Security Policy, while migrating to a cloud-based solution."], "services": ["Established an enterprise architecture assessment through a review of the existing system infrastructure(s) and dependencies to identify opportunities for modernization and enhancement.", "Utilized industry-leading frameworks to design a resilient, highly available cloud migration strategy and infrastructure that meets government compliance requirements, focusing on a serverless, low-maintenance architecture that simplifies ongoing operations.", "Developed a networking and infrastructure plan that supports both cloud and hybrid environments, ensuring secure, efficient connectivity for all users.", "Outlined government cloud-based identity management solutions and migration recommendations to support seamless integration and continued compliance with security standards."], "outcomes": ["Provided comprehensive recommendations for a highly available, resilient, and reliable architecture by implementing best practices for designing a highly available cloud infrastructure.", "Delivered a migration roadmap describing the requirements (business, technical, quality, security, etc.) for migrating the agency\u2019s system(s) to the Cloud, including the recommended tools that shall be used in the migration.", "Provided a final report and set of recommendations to senior leadership and executive sponsors research, evaluation, findings, risks assessment and recommendations for the proposed cloud solution."]} /-->

<!-- wp:xfact/cta-section {"align":"full","title":"Ready to strengthen your systems?","subtitle":"Schedule an assessment to understand your current environment and identify a path forward.","buttons":[{"label":"Contact Us","url":"/contact","variant":"primary"}]} /-->'
fi

CS4_ID=$(wp post list --post_type=case_study --name=enterprise-risk-management-plan --field=ID 2>/dev/null)
if [ -n "$CS4_ID" ]; then
    wp post update "$CS4_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"Case Studies","title":"Enterprise Risk Management Plan","subtitle":"Risk Management Office of a State-wide IT Agency"} /-->

<!-- wp:xfact/case-study-details {"summary":"Built a scalable ERM program for a growing state-wide IT agency, enabling consistent risk oversight, regulatory compliance, and informed decision-making across newly integrated units.","source":"xFact","client":"Major Public Sector Criminal Justice Agency","challenge":["Create an ERM framework for a newly-established Enterprise Risk Management Office (ERMO)","Provide continuity of implementation across an organization undergoing significant growth and transformation, including consolidation of units from other government agencies","Educate business units across the enterprise on new ERM program"],"services":["C-level client interaction, management and reporting","Program development and support to Chief Risk Officer and ERMO","Risk assessment workshops","Development of actionable strategic recommendations to realize “to be” goals, including funding requirements"],"outcomes":["Established foundational ERM framework","Completed comprehensive Internal Control Plan for regulatory review","Developed organizational and departmental Risk Appetite Statement documents","Implemented enterprise-wide Risk Register","Implemented ERM policy framework"]} /-->

<!-- wp:xfact/cta-section {"title":"Ready to strengthen your systems?","subtitle":"Schedule an assessment to understand your current environment and identify a path forward.","buttons":[{"label":"Contact Us","url":"/contact","variant":"primary"}]} /-->'
fi

CS5_ID=$(wp post list --post_type=case_study --name=hybrid-cloud-data-center-migration --field=ID 2>/dev/null)
if [ -n "$CS5_ID" ]; then
    wp post update "$CS5_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"Case Studies","title":"Hybrid Cloud Data Center Migration","subtitle":"Major State-wide IT Agency\
"} /-->

<!-- wp:xfact/case-study-details {"summary":"Enabled a cost-effective transition to a hybrid and multi-cloud environment for a state-wide IT agency, modernizing application infrastructure while maintaining operational continuity, improving security, and supporting future scalability.","source":"xFact","client":"Major State-wide IT Agency","challenge":["Plan and implement cost-sensitive modernization efforts while also providing continuity of operations","Identify multi-cloud solutions that reduce operational and technical complexity while enhancing security (mitigation of malware,ransomware, disaster recovery, etc.)","Leverage existing assets while supporting future-forward infrastructure and development efforts"],"services":["Engagement of technical and C-level stakeholders to define strategic goals for application portfolio modernization","Development and analysis of detailed application portfolio inventories and critical path actions for modernization","Architecting of cloud, multi-cloud, and hybrid-cloud options to fit client needs","Implementation of IaaS and DaaS solutions"],"outcomes":["Developed Enterprise Technical Standards (ETS) for app. portfolio modernization and cloud migration","Facilitated an IaaS-based data center migration plan and implementation framework","Established a cloud/multi-cloud/hybrid-cloud migration architecture","Implemented IaaS, DaaS, and PaaS technical environments for application data center migration"]} /-->

<!-- wp:xfact/cta-section {"title":"Ready to strengthen your systems?","subtitle":"Schedule an assessment to understand your current environment and identify a path forward.","buttons":[{"label":"Contact Us","url":"/contact","variant":"primary"}]} /-->'
fi

CS6_ID=$(wp post list --post_type=case_study --name=covid-19-collaboration-remote-work-enablement --field=ID 2>/dev/null)
if [ -n "$CS6_ID" ]; then
    wp post update "$CS6_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"Case Studies","title":"Covid19 and Collaboration ","subtitle":"Enabled seamless remote work transition during COVID-19 by leveraging secure collaboration tools and ensuring uninterrupted business continuity across the organization."} /-->

<!-- wp:xfact/case-study-details {"summary":"Enabled DataServ to rapidly transition to a remote workforce during the COVID-19 crisis by leveraging an established collaboration framework, ensuring business continuity, secure operations, and uninterrupted client support.","source":"Dataserv","client":"DataServ","challenge":["Rapidly transition to a remote work environment during the COVID-19 pandemic while maintaining business continuity and productivity.","Adapt existing continuity plans to support large-scale remote collaboration and secure operations.","Ensure seamless communication, workflow efficiency, and employee connectivity without disruption."],"services":["Executed a well-established Emergency Response Plan to quickly enable remote operations.","Leveraged existing collaborative infrastructure including VPN, secure email, multi-factor authentication, and video conferencing tools.","Assessed employee workflows and pain points to optimize collaboration and productivity.","Strengthened secure access, communication systems, and process efficiency across distributed teams."],"outcomes":["Successfully transitioned over 90% of the workforce to remote operations with no business disruption.","Maintained secure, efficient, and scalable collaboration across the organization.","Enhanced productivity and operational resilience through a strong collaboration framework.","Enabled continued client support and service delivery during a global crisis."],"narrative":"A collaborative mindset and culture go beyond a collaboration solution. It is the assessment and planning before the implementation that truly makes the difference. Our people and our processes laid the foundation of our company’s collaborative culture and infrastructure. We assessed our team member’s pain points, evaluated their workflows, and sought to implement a collaborative framework using technology that would allow an increase in efficiency and productivity."} /-->

<!-- wp:xfact/cta-section {"title":"Ready to strengthen your systems?","subtitle":"Schedule an assessment to understand your current environment and identify a path forward.","buttons":[{"label":"Contact Us","url":"/contact","variant":"primary"}]} /-->'
fi

CS7_ID=$(wp post list --post_type=case_study --name=healthcare --field=ID 2>/dev/null)
if [ -n "$CS7_ID" ]; then
    wp post update "$CS7_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"Case Studies","title":"Healthcare","subtitle":"Modernized healthcare IT infrastructure for Ohio Masonic Home, enabling a secure, scalable in-house environment that improved operational efficiency and supported long-term digital transformation."} /-->

<!-- wp:xfact/case-study-details {"summary":"Operational and infrastructure improvements for a regional healthcare provider, focused on reliability and continuous availability.","source":"DataServ","client":"Ohio Masonic Home","challenge":["Migrate from a struggling hosted server provider to an in-house IT environment without disruption to operations.","Lack of strategic technology roadmap for scalability, growth, and future innovation.","Need for stable, secure, and efficient infrastructure to support mission-critical senior care services."],"services":["Conducted a comprehensive IT and infrastructure assessment to identify gaps and priorities.","Designed and executed a data center and technology conversion with rapid stabilization of systems.","Remediated legacy vendor issues and established a long-term technology roadmap.","Deployed and managed core IT services including collaboration tools, infrastructure, security, and operations support.","Implemented real-time monitoring, automation, and centralized documentation for improved efficiency and visibility."],"outcomes":["Successfully transitioned to a stable, scalable in-house IT infrastructure with minimal disruption.","Improved operational efficiency through streamlined workflows and modern collaboration tools.","Enhanced security, reliability, and system performance across the organization.","Enabled continuous innovation through ongoing strategic IT planning and managed services.","Established a long-term strategic partnership supporting digital transformation and mission delivery."],"narrative":"xFact’s healthcare engagement with Ohio Masonic Home demonstrates how strategic infrastructure modernization and managed services can transform IT from a support function into a scalable, mission-critical utility that drives operational excellence and innovation."} /-->

<!-- wp:xfact/cta-section {"title":"Ready to strengthen your systems?","subtitle":"Schedule an assessment to understand your current environment and identify a path forward.","buttons":[{"label":"Contact Us","url":"/contact","variant":"primary"}]} /-->'
fi

CS8_ID=$(wp post list --post_type=case_study --name=hhs-child-welfare-case-management-system-modernization --field=ID 2>/dev/null)
if [ -n "$CS8_ID" ]; then
    wp post update "$CS8_ID" --post_content='<!-- wp:xfact/hero {"sectionLabel":"Case Studies","title":"HHS Child Welfare Case Management System Modernization","subtitle":"Modernized a legacy child welfare system with a mobile-first, user-centric platform, enhancing accessibility, efficiency, and service delivery for both agency staff and the public."} /-->

<!-- wp:xfact/case-study-details {"summary":"Modernization of a state child-welfare case-management platform, replacing siloed legacy tooling with an integrated system.","source":"xFact","client":"State-wide Agency for Children and Families","challenge":["Modernizing the core technology platform and infrastructure of a critical legacy system to align with the agency'\''s strategic goals and operational constraints","Implementing a new, user-driven design to ensure a consistent and effective UI/UX across a diverse user base (including a mobile workforce of over 3,000)","Ensuring secure and efficient mobile access to the agency’s technology platform, tailored to the unique context of each user'\''s work environment"],"services":["Aligned the modernization effort with the agency’s strategic objectives, internal business processes, and legal/operational constraints, ensuring a holistic approach to modernization","Collaboratively designed and implemented updates to the legacy system’s core technology stack and application architecture to support modernization efforts and long-term sustainability of the solution","Designed and developed a modern, intuitive responsive user interface for desktops, tablets, and mobile devices to facilitate easier access and interaction for all users","Developed a public-facing digital platform that allows the public and mandated reporters to easily report child abuse and neglect through the state'\''s portal"],"outcomes":["Mitigation of technical debt and increased sustainability and extensibility of the legacy system application architecture","Significant improvements to the end-user experience, leading to increased satisfaction and productivity among the agency’s workforce and mobile user base"," By leveraging the agency’s public website as a digital channel, the system extended the reach and impact of HHS services, aligning with the agency’s mission to provide constituent-centric services and offering easier processes for constituents and mandated reporters to report child abuse and neglect, promoting timelier interventions and support.","Real-time access to information via tablets and smartphones, enhancing decision-making capabilities in the field"],"narrative":"The Enterprise Modernization and Mobility Project exemplifies the xFact team\u005c'\''s commitment to leveraging innovative technology solutions to improve public service delivery. By prioritizing user experience and embracing a mobile-first approach, the project has set a new standard for digital engagement and operational efficiency within the HHS agency, making a tangible difference in the lives of both the agency'\''s employees and the populations they serve."} /-->

...
<!-- wp:xfact/navigation-cards {"sectionLabel":"MORE INDUSTRIES","heading":"Other systems we support","items":[{"title":"Public Safety \u0026 Justice","icon":"Shield","href":"/solutions/public-safety"},{"title":"Municipal, State \u0026 Local Government","icon":"Landmark","href":"/solutions/government"},{"title":"Education","icon":"GraduationCap","href":"/solutions/education"},{"title":"Health \u0026 Human Services","icon":"HeartPulse","href":"/solutions/health-and-human-services"}]} /-->
...
<!-- wp:xfact/cta-section {"title":"Ready to strengthen your systems?","subtitle":"Schedule an assessment to understand your current environment and identify a path forward."} /-->'
fi

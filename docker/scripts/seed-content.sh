...
if [ -n "$NEWS_ID" ]; then
    wp post update "$NEWS_ID" --post_content='<!-- wp:xfact/page-hero {"sectionLabel":"News \u0026 Insights","heading":"News \u0026 Insights","subtitle":"Perspectives on public-sector systems and the technology behind them.","align":"full"} /-->
...
if [ -n "$CS1_ID" ]; then
    wp post update "$CS1_ID" --post_content='<!-- wp:xfact/page-hero {"sectionLabel": "Case Studies", "heading": "Public Safety Data Broker Solution", "subtitle": "A high-volume, fault-tolerant message broker enabling standardized criminal-justice information sharing across state, federal, and international systems.", "align": "full"} /-->
...
if [ -n "$CS2_ID" ]; then
    wp post update "$CS2_ID" --post_content='<!-- wp:xfact/page-hero {"sectionLabel": "Case Studies", "heading": "License Management System", "subtitle": "A modular firearms-licensing platform rolled out across 350+ local police departments and all state-licensed firearms dealers \u2014 the first solution of its kind in the USA.", "align": "full"} /-->
...
if [ -n "$CS3_ID" ]; then
    wp post update "$CS3_ID" --post_content='<!-- wp:xfact/page-hero {"sectionLabel": "Case Studies", "heading": "Cloud Migration Strategic Roadmap", "subtitle": "A comprehensive cloud migration roadmap and serverless architecture recommendations for a major criminal-justice agency, meeting FedRAMP High and CJIS compliance.", "align": "full"} /-->
...
if [ -n "$CS4_ID" ]; then
    wp post update "$CS4_ID" --post_content='<!-- wp:xfact/page-hero {"sectionLabel":"Case Studies","heading":"Enterprise Risk Management Plan","subtitle":"Risk Management Office of a State-wide IT Agency"} /-->
...
if [ -n "$CS5_ID" ]; then
    wp post update "$CS5_ID" --post_content='<!-- wp:xfact/page-hero {"sectionLabel":"Case Studies","heading":"Hybrid Cloud Data Center Migration","subtitle":"Major State-wide IT Agency\
"} /-->
...
if [ -n "$CS6_ID" ]; then
    wp post update "$CS6_ID" --post_content='<!-- wp:xfact/page-hero {"sectionLabel":"Case Studies","heading":"Covid19 and Collaboration ","subtitle":"Enabled seamless remote work transition during COVID-19 by leveraging secure collaboration tools and ensuring uninterrupted business continuity across the organization."} /-->
...
if [ -n "$CS7_ID" ]; then
    wp post update "$CS7_ID" --post_content='<!-- wp:xfact/page-hero {"sectionLabel":"Case Studies","heading":"Healthcare","subtitle":"Modernized healthcare IT infrastructure for Ohio Masonic Home, enabling a secure, scalable in-house environment that improved operational efficiency and supported long-term digital transformation."} /-->
...
if [ -n "$CS8_ID" ]; then
    wp post update "$CS8_ID" --post_content='<!-- wp:xfact/page-hero {"sectionLabel":"Case Studies","heading":"HHS Child Welfare Case Management System Modernization","subtitle":"Modernized a legacy child welfare system with a mobile-first, user-centric platform, enhancing accessibility, efficiency, and service delivery for both agency staff and the public."} /-->

...
if [ -n "$CAP_ID" ]; then
    wp post update "$CAP_ID" --post_content='<!-- wp:xfact/hero {"backgroundImage":"'"${ASSETS}"'/hero-solutions.jpg","sectionLabel":"Capabilities","title":"Integrated Capabilities for Mission-Critical Systems","subtitle":"Coordinated expertise supporting systems across their full lifecycle — from idea to action, design through long-term operation.","align":"full"} /-->
...
<!-- wp:xfact/cta-section {"variant":"light","align":"full","title":"Bring it all together.","subtitle":"Talk to us about coordinating your environments under one accountable partner.","buttons":[{"label":"Start a conversation","url":"/contact","variant":"primary"}]} /-->'
...
if [ -n "$NEWS_ID" ]; then
    wp post update "$NEWS_ID" --post_content='<!-- wp:xfact/hero {"backgroundImage":"'"${ASSETS}"'/hero-contact.jpg","sectionLabel":"News \u0026 Insights","title":"News \u0026 Insights","subtitle":"Perspectives on public-sector systems and the technology behind them.","align":"full"} /-->
...
<!-- wp:xfact/cta-section {"variant":"light","align":"full","title":"Want to talk shop?","subtitle":"We share insights privately, too. Reach out and we can dive in on your environment.","buttons":[{"label":"Contact us","url":"/contact","variant":"primary"}]} /-->'
    echo "  ✅ Seeded: News"
fi
...
<!-- wp:xfact/navigation-cards {"sectionLabel":"MORE INDUSTRIES","heading":"Other systems we support","items":[{"title":"Public Safety & Justice","icon":"Shield","href":"/solutions/public-safety"},{"title":"Municipal, State & Local Government","icon":"Landmark","href":"/solutions/government"},{"title":"Education","icon":"GraduationCap","href":"/solutions/education"},{"title":"Health & Human Services","icon":"HeartPulse","href":"/solutions/health-and-human-services"}],"buttons":[]} /-->
...
<!-- wp:xfact/cta-section {"variant":"dark","title":"Existing Client?","subtitle":"Access your support portal to submit tickets, track issues, and review service history.","buttons":[{"label":"Open Support Portal","url":"https://portal.dataservtech.com/","variant":"primary"}]} /-->'
    echo "  ✅ Seeded: Support"
fi
...
<!-- wp:xfact/cta-section {"variant":"dark","align":"full","title":"Interested in joining the team?","subtitle":"We'\''re always looking for talented people who want to do meaningful work.","buttons":[{"label":"Get in Touch","url":"/contact","variant":"primary"}]} /-->'
    echo "  ✅ Seeded: Careers"
fi
